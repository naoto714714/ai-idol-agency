    ...
    <div className="min-h-screen flex flex-col bg-background font-sans selection:bg-primary/20 selection:text-primary-foreground">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-white/80 backdrop-blur-md supports-[backdrop-filter]:bg-white/60">
        <div className="container flex h-16 items-center justify-between">
          <Link href="/">
            <a className="flex items-center gap-2 font-bold text-xl tracking-tight hover:opacity-80 transition-opacity">
      ...
      <footer className="border-t border-border bg-muted/30 py-12">
        <div className="container grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2 space-y-4">
            <h3 className="font-bold text-lg bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">PRISM BEAT</h3>
            <p className="text-sm text-muted-foreground max-w-xs font-serif leading-relaxed">
              AIがプロデュースする、物語を持ったアイドル事務所。<br/>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/members"><a className="hover:text-primary transition-colors">Members</a></Link></li>
              <li><Link href="/sns"><a className="hover:text-primary transition-colors">SNS Log</a></Link></li>
              <li><Link href="/archive"><a className="hover:text-primary transition-colors">Archive</a></Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/about"><a className="hover:text-primary transition-colors">About Project</a></Link></li>
